...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const css = [
			...
			".dup-logo{flex:none;width:56px;height:56px;border-radius:14px;display:flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#4d6bfe,#6b8cff);box-shadow:0 6px 18px rgba(77,107,254,.28)}",
			".dup-logo svg{display:block}",
			".dup-heroTitle{display:flex;flex-direction:column;gap:2px}",
			".dup-productName{font-size:18px;font-weight:600;line-height:26px;margin:0}",
			".dup-productSub{font-size:12px;line-height:18px;color:var(--dsw-alias-label-tertiary);margin:0}",
		...
		const LOGO_SVG =
			...
			'<path d="M24 10 35 23h-7v7h-8v-7h-7L24 10Z" fill="#fff"/>' +
			'<rect x="13" y="34" width="22" height="3.5" rx="1.75" fill="#fff"/>' +
			"</svg>";
				...
				children: [
					jsxs("div", {
						...
						children: [
							...
							jsxs("div", {
								className: "dup-heroTitle",
								children: [
									jsx("h2", { className: "dup-productName", children: "DeepSeek Harness" }),
									jsx("p", { className: "dup-productSub", children: "DeepSeek Harness · dsh CLI 与 Web 界面" })
								]
							})
						]
					}),
